...
function buildReport({ title, bugs, passes, screenshots, scormCalls, input }) {
  ...
  function ssImg(key) {
    ...
    const data = (() => {
      ...
      return 'data:image/png;base64,' + fs.readFileSync(screenshots[key]).toString('base64');
    })();
    if (!data) return '';
...
<div class="header">
  ...
  <div class="sub">Tested: <strong>${now}</strong> &nbsp;·&nbsp; Tool: <strong>Automated QA Script v1.0</strong></div>
</div>
...
<footer>
  Generated by SCORM QA Tool &nbsp;·&nbsp; ${now}
</footer>
</body>
</html>`;
}
